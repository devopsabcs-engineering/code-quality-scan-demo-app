...
```text
feature/1234-add-lint-scan
feature/1235-fix-coverage-threshold
```
...
```text
feat: add code quality scan pipeline AB#1234
fix: correct coverage threshold check AB#1235
```
...
```text
feat: add code quality scan pipeline Fixes AB#1234
```
